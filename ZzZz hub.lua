...
local Window = Fluent:CreateWindow({
    ...
    SubTitle = "Beta",
    TabWidth = 160,
    Size = UDim2.fromOffset(550, 366),
    Acrylic = true,
    Theme = "Dark",
    MinimizeKey = Enum.KeyCode.End
})
local Tabs = {
    Info = Window:AddTab({ Title = "Info", Icon = "code" }),
    Main = Window:AddTab({ Title = "Main", Icon = "home" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "settings" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "plus-circle" }),
    Player = Window:AddTab({ Title = "Player", Icon = "box" }),
    Teleport = Window:AddTab({ Title = "Island", Icon = "tree" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Hop", Icon = "code-2" }),
}
    ...
    function getHighestPoint()
        ...
        for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId == "rbxassetid://16824974842" then
                    return v
                end
            end
        end
...
if Second_Sea then
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Kill Kata v2", Default = false })
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://16824974842"
...
Tabs.Race:AddButton({
    Title = "Acient One",
    Description = "Tp Npc Mua Bánh Răng",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://16824974842")[1]:GetChildren()) do
	...
	Callback = function()
		...
		for k, v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy" .. v, true) == 1 then
				...
				huhu.Image = "rbxassetid://16824974842"
...
Tabs.Info:AddParagraph({
    ...
    Tabs.Info:AddButton({
        ...
        Callback = function()
  setclipboard("https://discord.gg/25gAngJBwX")
      end
    })
